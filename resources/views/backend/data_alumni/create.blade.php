        ...
        <div class="card card-plain">
            ...
            <div class="card-body">
                <form role="form" action="{{ route('alumni.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <label>Alamat</label>
                    <div class="mb-3">
                        <textarea type="text" name="alamat" id="alamat" placeholder="jalan/gang" class="form-control" required
                            value=""></textarea>
                    </div>
                    <label>Nama Ayah</label>
                    <div class="mb-3">
                        <input type="text" name="nama_ayah" placeholder="nama_ayah" id="nama_ayah" class="form-control"
                            value="">
                    </div>
                    <label>Nama Ibu</label>
                    <div class="mb-3">
                        <input type="text" name="nama_ibu" placeholder="nama_ibu" id="nama_ibu" class="form-control"
                            value="">
                    </div>
                    <label>Foto</label>
                    <div class="mb-3">
                        <input type="file" name="foto" placeholder="foto" id="foto" class="form-control"
                            value="">
                    </div>
                    @if ($errors->any())
