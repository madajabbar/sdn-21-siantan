            ...
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <a href="{{isset($data->dataAlumni->link) ? asset('storage/'. $data->dataAlumni->link) : '#'}}">
                        <div class="card mb-3">
                            <img class="card-img img-fluid" src="{{asset('frontend\assets\img\ijazah.jpg')}}" alt="https://www.freepik.com/free-vector/social-media-illustration_5275573.htm#query=document&position=1&from_view=search"
                                id="product-detail">
                        </div>
                        <h1 class="h1 text-center"> {{$data->dataAlumni->link ? 'DOWNLOAD IJAZAH':'AKUN BELUM TERVERIFIKASI'}}</h1>
                    </a>
                </div>
                <!-- col end -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row m-3">
                                ...
                                <h1 class="h3 col-1">:</h1>
                                <h1 class="h3 col-8">{{ isset($data->nisn) ? $data->nisn : 'Data NISN Belum dimasukan'}}</h1>
                            </div>
                            <div class="row m-3">
                            ...
                            <div class="row m-3">
                                ...
                                <h1 class="h3 col-1">:</h1>
                                <h1 class="h3 col-8">{{ $data->dataAlumni->tempat_lahir . ' ' . $data->dataAlumni->tanggal_lahir}}</h1>
                            </div>
                            <div class="row m-3">
